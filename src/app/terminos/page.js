export default function TermsPage() {
  return (
    <div className="mx-auto max-w-2xl">
      <h1 className="mb-4 font-serif text-2xl font-semibold text-ink">Términos y Condiciones</h1>
      <p className="mb-4 rounded-lg border border-dashed border-ochre bg-[#EFE7D2] px-4 py-3 text-sm text-[#5c5537]">
        Texto placeholder. Reemplazar por una versión revisada por un abogado antes de lanzar a
        producción (ver brief, punto 11).
      </p>
